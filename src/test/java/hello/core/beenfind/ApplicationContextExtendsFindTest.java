...
public class ApplicationContextExtendsFindTest {
    ...
    @Test
    @DisplayName("부모 타입으로 조회시, 자식이 둘 이상 있으면, 빈 이름을 지정 해주면 된다")
    ...
    void findBeanBySubType(){
        DiscountPolicy bean = ac.getBean("rateDiscountPolicy", RateDiscoutPolicy.class);
        assertThat(bean).isInstanceOf(RateDiscoutPolicy.class);
    }
    ...
    void findBeanAllByParentTypeObject() {
